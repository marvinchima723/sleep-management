...
// ─── Slide 8: TECH MOAT ─────────────────────────────────────────────────────
{
  ...
  const moats = [
    { icon: "⚗️", title: "材料提纯", color: C.accent, desc: "独创四步法核心提纯工艺——酸溶、载体共沉/选择性吸附/离子交换分离Ra、矿物纯化、再合成——彻底去除放射性镭（Ra），保留并激活负氧离子释放活性，技术壁垒高、难复制。", items: ["酸溶将镭转入溶液体系", "载体共沉/选择性吸附/离子交换分离Ra", "纯化主体矿物组分", "重新合成高活性负氧离子粉", "零臭氧、零辐射", "森林级浓度无醉氧"] },
